...
def destination_location(homeLattitude, homeLongitude, distance, bearing):
    try:
        ...
        print("destination location fail")
...
def distance_to_current_waypoint():
    try:
        ...
        print("distance to waypoint fail")
#sorting functions
