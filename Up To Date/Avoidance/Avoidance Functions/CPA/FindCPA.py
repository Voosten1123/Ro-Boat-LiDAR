...
def FindCPA (Course, Bearing1, Range1, Time1, Bearing2, Range2, Time2):
    ...
    print("CPA Bearing: "+ str(math.degrees(CPABearing)) + " || CPA Range: "+str(CPADistance)+ " || CPATime: "+str(CPATime)+ " || CPA ETA: "+ str(CPAEta))

FindCPA(0, 30, 20, 0, 10, 15, 2)
