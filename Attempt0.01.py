...
while li < 5:
    ...
    datay = []
    dataz = []
    datax = process_scan(get_scan(), 1.2, 3)
    datay = process_scan(get_scan(), 1.2, 3)
    dataz = Compare_Scans(datax, datay, 3, 10, 100, 120)

    #print('Comparison')
    #print('--------------------Data of 1st scan----------------------------')
    #print(datax)
    #print('--------------------Data of 2nd scan----------------------------')
    #print(datay)
    print('--------------------Data of com scan----------------------------')
    il = 0
    print(len(dataz))
    while il < len(dataz):
        print('Id : ', il+1,  ' | Quality:', dataz[il][1][0], ' | Angle:', dataz[il][1][1],' | Distance:', dataz[il][1][2],' | Length:', dataz[il][1][3])
        il +=1
    #print(dataz)
    li += 1
